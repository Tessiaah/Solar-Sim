...
BODY_FACTS = {
    ...
    "Mercury": (
        "facts.mercury.closestToSun",
        "facts.mercury.year88Days",
        "facts.mercury.solarDay176Days",
        "facts.mercury.almostNoAtmosphere",
        "facts.mercury.temperatureSwings",
    ),
    "Venus": (
        "facts.venus.hottestPlanet",
        "facts.venus.co2Atmosphere",
        "facts.venus.retrogradeSpin",
        "facts.venus.crushingPressure",
        "facts.venus.sisterPlanet",
    ),
    "Earth": (
        "facts.earth.life",
        "facts.earth.surfaceWater",
        "facts.earth.plateTectonics",
        "facts.earth.nitrogenOxygen",
        "facts.earth.moon",
        "facts.earth.notRomanGod",
    ),
    "Mars": (
        "facts.mars.redPlanet",
        "facts.mars.olympusMons",
        "facts.mars.vallesMarineris",
        "facts.mars.ancientWater",
        "facts.mars.phobosDeimos",
        "facts.mars.day246Hours",
    ),
    "Jupiter": (
        "facts.jupiter.largestPlanet",
        "facts.jupiter.hydrogenHelium",
        "facts.jupiter.greatRedSpot",
        "facts.jupiter.manyMoons",
        "facts.jupiter.strongestMagneticField",
        "facts.jupiter.earthsInside",
    ),
    "Saturn": (
        "facts.saturn.ringSystem",
        "facts.saturn.lessDenseThanWater",
        "facts.saturn.hydrogenHelium",
        "facts.saturn.manyMoonsTitan",
        "facts.saturn.titanAtmosphere",
        "facts.saturn.extremeWinds",
    ),
    "Uranus": (
        "facts.uranus.sidewaysRotation",
        "facts.uranus.methaneColor",
        "facts.uranus.coldestAtmosphere",
        "facts.uranus.faintRings",
        "facts.uranus.year84EarthYears",
        "facts.uranus.retrogradeSpin",
    ),
    "Neptune": (
        "facts.neptune.farthestMajorPlanet",
        "facts.neptune.methaneBlue",
        "facts.neptune.fastestWinds",
        "facts.neptune.year165EarthYears",
        "facts.neptune.discoveredWithMath",
        "facts.neptune.tritonMoon",
    ),
}
