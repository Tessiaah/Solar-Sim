...
- `mercury.jpg`: NASA/JPL simulator texture map, downloaded from `https://space.jpl.nasa.gov/tmaps/pix/mer0muu2.jpg`.
...
- `uranus.jpg`: Solar System Scope Uranus texture, downloaded from `https://www.solarsystemscope.com/textures/download/2k_uranus.jpg`.
